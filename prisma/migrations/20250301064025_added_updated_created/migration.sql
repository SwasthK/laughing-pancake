/*
  ...
  - Added the required column `updatedAt` to the `EventHead` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `Poster` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "EventHead" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
...
-- AlterTable
ALTER TABLE "Poster" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
